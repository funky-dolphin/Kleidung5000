...
# so you can run the seed file multiple times without having duplicate entries in your database
    ...
    i41=Item(condition=10, image="https://img.ssensemedia.com/images/b_white,g_center,f_auto,q_auto:best/231358M195019_1/dries-van-noten-khaki-paneled-blazer.jpg", color="Khaki", name="Paneled Blazer", price=1425.00, for_sale=True, owner_id=2, type_id=1, subtype_id=4, size_id=1,brand_id=12)
