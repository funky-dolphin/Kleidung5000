          ...
          <Card className="mt-5">
            <Card.Body>
              ...
              <Form.Group controlId="formBasicName" className="mt-3">
                  ...
                  <Form.Control onChange = {(e) => setRegisterName(e.target.value)} type="text" placeholder="Enter your name" />
                </Form.Group>
                <Form.Group controlId="formBasicName" className="mt-3">
                  <Form.Label>Userame</Form.Label>
                  <Form.Control onChange = {(e) => setRegisterUsername(e.target.value)} type="text" placeholder="Enter your username" />
                </Form.Group>
                <Form.Group controlId="formBasicUsername" className="mt-3">
                  <Form.Label>Zipcode</Form.Label>
                  <Form.Control onChange = {(e) => setRegisterZipcode(e.target.value)} type="text" placeholder="Enter your Zipcode" />
                </Form.Group>
                <Form.Group controlId="formBasicEmail" className="mt-3">
                  <Form.Label>Email address</Form.Label>
                  <Form.Control onChange = {(e) => setRegisterEmail_address(e.target.value)}type="email" placeholder="Enter email" />
                </Form.Group>
                <Form.Group controlId="formBasicPaypal" className="mt-3">
                  <Form.Label>Paypal Address</Form.Label>
                  <Form.Control onChange = {(e) => setRegisterPaypall_address(e.target.value)} type="text" placeholder="Enter your Paypal Address" />
                </Form.Group>
